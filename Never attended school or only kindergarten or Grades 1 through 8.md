...
exploratory data analysis for the highest education level of Never
attended school or only kindergarten or Grades 1 through 8.
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/diabetes%20numbers%20breakdown-1.png)<!-- -->
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/age%20and%20diabetes-1.png)<!-- -->
...
```
    ...
    ##  0.62  1.23  2.68  4.06  5.24  6.33  9.32  9.51 10.77 12.40 12.05 10.58 15.22
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/bmi%20and%20diabetes-1.png)<!-- -->
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/bmi%20boxplot-1.png)<!-- -->
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/sex%20with%20diabetes-1.png)<!-- -->
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/general%20health%20box%20plot-1.png)<!-- -->
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/high%20blood%20pressure%20box%20plot-1.png)<!-- -->
...
![](Never%20attended%20school%20or%20only%20kindergarten%20or%20Grades%201%20through%208_files/figure-gfm/Physical%20Activity%20Box%20Plot-1.png)<!-- -->
...
education level of Never attended school or only kindergarten or Grades
1 through 8. Use $p = 0.7$ as told in the directions. The training data
will be used to help make the models and the testing data will help us
...
```
    ...
    ## GenHlthpoor                            76.14
    ## GenHlthfair                            59.68
    ## HeartDiseaseorAttack                   53.60
    ## HvyAlcoholConsump                      50.46
    ## `Income$35,000 to less than $50,000`   38.24
    ## CholCheck                              35.74
    ## GenHlthgood                            35.09
    ## `Income$15,000 to less than $20,000`   30.51
    ## Fruits                                 26.37
    ## `Income$50,000 to less than $75,000`   23.00
    ## `Age65-69`                             20.31
    ## `Income$20,000 to less than $25,000`   19.41
    ## `Age70-74`                             19.18
    ## `Age75-79`                             18.39
    ## NoDocbcCost                            17.74
    ## `Age80+`                               17.28
    ## `Income$25,000 to less than $35,000`   17.11
...
0.5227825. We are now going to see if we should include some
...
0.5409731. We are now going to see if we this data is better represented
...
We get our log loss here on the linear model with interaction being
0.529704. Now what we do is select the model with the lowest error rate.
...
```
    ...
    ##                                              s1
    ## (Intercept)                        -1.122726018
    ## BMI                                 0.291066533
    ## GenHlthvery good                   -0.014633291
    ## GenHlthgood                         0.098676613
    ## GenHlthfair                         0.332247243
    ## GenHlthpoor                         0.417137351
    ## MentHlth                            .          
    ## PhysHlth                           -0.015682479
    ## Age25-29                           -0.091834421
    ## Age30-34                           -0.148884551
    ## Age35-39                           -0.168379828
    ## Age40-44                           -0.204158746
    ## Age45-49                           -0.033529952
    ## Age50-54                           -0.093536307
    ## Age55-59                            .          
    ## Age60-64                            .          
    ## Age65-69                            0.087046763
    ## Age70-74                            0.060520241
    ## Age75-79                            0.038366658
    ## Age80+                              0.013962959
    ## Income$10,000 to less than $15,000  .          
    ## Income$15,000 to less than $20,000 -0.071266984
    ## Income$20,000 to less than $25,000 -0.031207805
    ## Income$25,000 to less than $35,000 -0.027328425
    ## Income$35,000 to less than $50,000 -0.105143769
    ## Income$50,000 to less than $75,000 -0.057785772
    ## Income$75,000 or more              -0.039565060
    ## HighBP                              0.328293253
    ## HighChol                            0.336802815
    ## CholCheck                           0.153011223
    ## Smoker                             -0.004191039
    ## Stroke                             -0.007994733
    ## HeartDiseaseorAttack                0.154925039
    ## PhysActivity                        .          
    ## Fruits                              0.067488605
    ## Veggies                             .          
    ## HvyAlcoholConsump                  -0.222101060
    ## AnyHealthcare                       0.012078320
    ## NoDocbcCost                        -0.053633851
    ## DiffWalk                            0.006547592
    ## Sex                                 .
...
```
    ...
    ##                               log_loss
    ## Logistic Regression          0.5227825
    ## Lasso                        0.5201694
    ## Classification tree          0.5696389
    ## Random Forest                0.5257616
    ## Linear Discriminant Analysis 0.5211075
    ## Support Vector Classifier    0.5932602

As we can see here the best model for our data for the highest education
level of Never attended school or only kindergarten or Grades 1 through
8 is the Lasso model.
